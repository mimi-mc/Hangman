...
let hiddenWord = [];
let displayedNoLives_isADomElement = document.getElementById("noLives");
let noLives = +displayedNoLives_isADomElement.innerText;
...
function checkLetter() {
   ...
   if (isInWord === 0) {
      ...
      --noLives;
      displayedNoLives_isADomElement.innerText = noLives;
      if (noLives === 0) {
